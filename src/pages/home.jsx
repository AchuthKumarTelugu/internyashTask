...
function Home() {
  return ( 
      ...
      {/* <
        ...
        Crowned with Innovations “Elevating Culinary Excellence”  < /
        div > <p>
        Welcome to Nutryfood!We believe in blending tradition with innovation to make cooking easier and faster.Our smart research makes cooking simple and delicious.We want everyone to enjoy good food without the hassle. We mix new and old cooking methods to create amazing flavors in
      ...
      <div className="cwi">
        ...
        <div className="cwipara">
          ...
          <p>We mix new and old cooking methods to create amazing flavors in
            Indian cuisine.Our goal is to share authentic Indian food with the world
            while keeping it healthy and tasty.</p>
          <p>At Nutryfood, we make sure everyone can afford great food.Our solutions are budget - friendly
            for every kitchen.Come join us on a journey of tasty meals and innovative ideas, making every dining experience memorable.</p>
        </div>
      </div>
      <div className="imgtext">
        <div className="imgtext-col">
          <img src="./homenso.svg" className='imgtext-img' alt="" />
          <h1>Nutritionaly Superior Option</h1>
        </div>
        <div className="imgtext-col">
          <img src="./homeathm.svg" className='imgtext-img' alt="" />
          <h1>Ancient, Time-Honoured Method</h1>
        </div>
        <div className="imgtext-col">
          <img src="./homenppf.svg" className='imgtext-img' alt="" />
          <h1>No preservatives, pure freshness</h1></div>
        <div className="imgtext-col">
          <img src="./homeawe.svg" className='imgtext-img' alt="" />
          <h1>Accessible world wide,everywhere</h1></div>
        <div className="imgtext-col"><img src="./homeawsq.svg" className='imgtext-img' alt="" />
          <h1>Afordabel without sacrificing quality</h1></div>
      </div>
      <div className="full-width-image">
        <img src="./homecoock.png" alt="" />
      </div>
      {/* <div className="wwr">
        <div className="wwrheading">
          <h2>Who we are?</h2>
        </div>
        <div className="wwr-row">
          <div className="wwr-img">
            <img src="./homewwr" alt="" />
          </div>
          <div className="wwr-para"></div>
        </div>
      </div> */}
...
<div class="container">
        <h1>Who We Are</h1>
        <div class="content">
            <img src="public\Frame 273.png" alt="Company Photo" class="photo"></img>
	...
	At Nutryfood, excellence is accessible to all, with cost-effective solutions for every kitchen. Join us on a journey where culinary creativity meets innovation, promising unforgettable dining experiences for all.</p>
      ...
      <div className="container">
        ...
        div > <
                      ...
                      >
                      <
                        div className="ready-to-mix" > Ready to Mix Millet Dosa Powder </div></div>
                  </div>
